...
- **Conciseness Mandate:** Keep codeblocks inside Svelte/TS components completely free of empty lines and comments for extreme readability and styling alignment.
...
- **Reader:** Core feature. Minimalist EPUB reader driven purely by Firebase Storage folders with offline Cache API and static locations caching.
...
- **Cipher:** Core offline-first Caesar cipher Daily Puzzle and local Cipher Creator. Streaks and URL-sharing are entirely removed to ensure absolute local simplicity.
